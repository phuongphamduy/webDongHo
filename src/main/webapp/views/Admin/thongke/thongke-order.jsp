...
<html>
  ...
  <body>
    ...
    <div style="margin-left: 15%; padding: 10px">
      <span style="font-size: 40px">Thống kê sản phẩm mua nhiều</span>
      <div class="card">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td style="width: 250px">1240</td>
              </tr>
              <tr>
                <td style="width: 20px">1</td>
                <td style="width: 600px">Đồng hồ mạ bạc</td>
                <td style="width: 250px">854</td>
              </tr>
              <tr>
                <td style="width: 20px">1</td>
                <td style="width: 600px">Đồng hồ Ridcha</td>
                <td style="width: 250px">999</td>
              </tr>
              <tr>
                <td style="width: 20px">1</td>
                <td style="width: 600px">Đồng hồ mạ vàng</td>
                <td style="width: 250px">425</td>
              </tr>
            </tbody>
          </table>
        </div>
